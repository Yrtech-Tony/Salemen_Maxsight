...
namespace XHX.View
{
    public partial class ShopScoreSearch : BaseForm
    {
        ...
        public void Search()
        {
            ...
            List<ShopScoreBodyDto> dataList = SearchBodyData(projectCode, shopCode, lossCheck, recheck);
        ...
        public List<ShopScoreBodyDto> SearchBodyData(string projectCode, string shopCode, bool lossCheck, bool recheck)
        {
            DataSet ds = webService.SearchBodyData(projectCode, shopCode, lossCheck, recheck);
