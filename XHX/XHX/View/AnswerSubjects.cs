    ...
    public partial class AnswerSubjects : BaseForm
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            service.SaveAnswer(ProjectCode_Golbal, SubjectCode_Golbal, ShopCode_Golbal,
                            ...
                            CheckType, passReCheck, DateTime.Now.ToString("yyyy-MM-dd"));
        ...
        private void btnUploadDataToServer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //Makefolder((CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text), "ftp://106.37.165.227/UpLoadImage/", "dsat", "dsat2011");
                    ...
                    //    DeleteFTPFile(url,
                    //        ("ftp://106.37.165.227/UpLoadImage" + "/" + (CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text+"/")).Replace("\\", "//"), "dsat", "dsat2011");
                    //}
                    foreach (string name in AllFilesList)
                    {
                        if (!name.Contains("Thumbs.db"))
                        {
                            ...
                            string url = temp[temp.Length - 1];
                            //DeleteFTPFile(url,
                            //    ("ftp://106.37.165.227/UpLoadImage" + "/" +
                            //    (CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text+@"/")).Replace("\\", "//"), "dsat", "dsat2011");
                            //Upload(name,
                            //    ("ftp://106.37.165.227/UpLoadImage" + "/" + (CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text) + "/" + url).Replace("\\", "//"), "dsat", "dsat2011");
